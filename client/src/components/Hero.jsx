...
const Hero = () => {
  ...
  return (
    ...
    justify-center w-full bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>

      <div className='text-center mb-6'>
        <h1 className='text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl font-semibold max-auto 
        leading-[1.2]'>Create amazing content with <br/> <span className='text-primary'>AI tools</span></h1>
