  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        ...
        { prompt, length: selectedLength.length }, // ✅ send only number
        {
      ...
      toast.error(error.response?.data?.message || error.message); // ✅ fixed catch
    }
    setLoading(false);
  };
    ...
    flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <button
          ...
          bg-gradient-to-r
           from-[#226BFF] to-[#65ADFF] text-white px-4 py-2 
           my-6 text-sm 
          ...
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex flex-col items-center gap-5
             text-gray-400">
              ...
              <p>Enter a topic and click "Generate article" to get 
                started</p>
            </div>
          </div>
        ) : (
